...
import { MediaRenderer, Web3Button, useActiveClaimCondition, useContract, useAddress } from "@thirdweb-dev/react";
...
export default function NFTComponent({ nft }: Props) {
    ...
    return (
        <Card key={nft.metadata.id} overflow={"hidden"}>
            ...
            {!isLoading && data ? (
                <Text fontSize={"large"} textAlign={"center"} my={5}  style={{ fontWeight: 'bold', color: 'Blue' }}
